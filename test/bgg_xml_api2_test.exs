defmodule BggXmlApi2Test do
  ...
  test "when multiple board games have the exact name, use the most recently published one" do
    use_cassette "search_and_info_on_arkham_horror" do
      {:ok, result} = BggXmlApi2.board_game_info("Arkham Horror")

      assert result.name == "Arkham Horror"
      assert result.year_published == "2005"
    end
  end
